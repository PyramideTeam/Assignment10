...
public class JWhiteBoard extends ReceiverAdapter implements ActionListener, ChannelListener {
	...
	private JPanel subPanel = null, messagePanel = null, groupPanel = null;// add
																			// messagePanel
	...
	private JButton clearButton, leaveButton, brushButton, backgroundButton, colorButton1, colorButton2, sendButton,
	...
	private Color backgroundColor = Color.WHITE, messageColor = Color.GRAY;
	...
	public void setGroupName(String groupName) {
		if (groupName != null)
			this.groupName = groupName;// Fixed added "this."
	}
	...
	private Color selectColor() {
		...
		return new Color(red, green, blue);// Fixed blue - green
	}
	...
	public void go() throws Exception {
		...
		txaMessage.setBounds(10, 10, 360, 420);
		...
		BrSize.setBounds(255, 20, 120, 25);
		...
		mainFrame.setBounds(new Rectangle(1007, 595));
	...
	public void receive(Message msg) {
		...
		try {
			...
			case DrawCommand.CLEAR:
				clearPanel();
			case DrawCommand.TEXT:// add case TEXT
